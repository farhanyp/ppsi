...
@if ($posts->count())
<div class="card mb-3">
    <img src="https://placeimg.com/1200/400/{{ $posts[0]->category->slug }}" class="card-img-top" alt="{{ $posts[0]->category->name }}">
...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-4 mb-3">
            <div class="card">
                <div class="position-absolute px-3 py-2 text-bold bg-blur text-white" style="background-color: rgba(0, 0, 0, 0.7
                )"> <a href="/posts?category={{ $post->category->slug }}" class="text-decoration-none text-white"> {{ $post->category->name }}</a></div>
                <img src="https://placeimg.com/500/400/{{ $post->category->slug }}" class="card-img-top" alt="{{ $post->category->name }}">
                <div class="card-body">
